...
public class Main {
	...
	public static void main(String[] args) {
       ...
       service.addProduct(new Product("BlackBeast", "Computer", "White Table", 2020));
	     ...
	     // Searching products place using Stream API
	        List<Product>p=service.getProductsWithPlace("white table");	   
	     // printing place using Stream API
	        p.stream().forEach(n->System.out.println(n));
	        
	     System.out.println("\n*****************************************************\n");
	     
		 System.out.println("Products OUT OF WARRANTY: ");  		 
		 // Searching products OUT OF WARRANTY using Stream API
	        List<Product>warr=service.getProductsOutOfWarranty();	   
	     // printing products OUT OF WARRANTY using Stream API
	        warr.stream().forEach(n->System.out.println(n));
